...
class Chess:
    ...
    def game(self, player_turn, dict_changes):
        turns = 2
        while True:
            ...
            if move == 'move':
                ...
                while True:
                    if start == 'd':
                        while start == 'd':
                            self.valid_move(list_of_moves[counter][0], another_player_turn)
                    ...
                    if start == 'a':
                        ...
                        while start == 'a':
                            ...
                            if start == 'a':
                                ...
                                player_turn -= 1
                    if start == '':
                        self.game(another_player_turn, dict_changes)
            if move == 'save game':
...
print(Chess_game_01.game(player_turn, dict_changes))